...
<head>
    <meta charset="UTF-8">
    <title>Cogni Connect - Cognisense</title>
...
/* =========================================================
           COGNI CONNECT — Ultra Premium (Discord-like, unique)
           Keeps all IDs + logic SAME.
           ========================================================= */
        ...
        :root{
            ...
            --cc-bg:
                radial-gradient(900px 520px at 15% 10%, rgba(56,189,248,.18), transparent 62%),
                radial-gradient(900px 520px at 85% 12%, rgba(79,70,229,.14), transparent 65%),
                linear-gradient(145deg, #e0eaff, #f0f4ff);

            --cc-surface: linear-gradient(135deg, rgba(255,255,255,.88), rgba(226,232,240,.84));
            --cc-surface-2: rgba(255,255,255,.55);

            --cc-border: rgba(148,163,184,.55);
            --cc-border-soft: rgba(148,163,184,.20);
            ...
            --cc-shadow: 0 26px 70px rgba(15,23,42,.14);
            --cc-shadow-2: 0 18px 55px rgba(15,23,42,.18);
        ...
        body.dark-mode{
            --cc-bg:
                radial-gradient(900px 520px at 15% 10%, rgba(56,189,248,.16), transparent 62%),
                radial-gradient(900px 520px at 85% 12%, rgba(129,140,248,.14), transparent 65%),
                linear-gradient(145deg, #0c0c0c, #050505);

            --cc-surface: linear-gradient(135deg, rgba(15,23,42,.96), rgba(2,6,23,.98));
            --cc-surface-2: rgba(2,6,23,.42);

            --cc-border: rgba(37,99,235,.60);
            --cc-border-soft: rgba(129,140,248,.18);

            --cc-text: #e5e7eb;
            --cc-muted: rgba(229,231,235,.68);

            --cc-shadow: 0 34px 90px rgba(0,0,0,.70);
            --cc-shadow-2: 0 18px 55px rgba(0,0,0,.55);
        }

        /* If you use dashboard shell, keep .main-content wrapper.
           We still force fit-to-screen nicely. */
        .main-content{
            min-height: 100vh;
        }

        /* Full-page fitting container */
        .cc-wrap{
            width: 100%;
            max-width: 1680px;
            margin: 0 auto;
            padding: var(--cc-page-pad);
            height: calc(100dvh - (var(--cc-page-pad) * 2));
            box-sizing: border-box;
        }

        /* Appbar (new) */
        .cc-appbar{
            height: var(--cc-appbar-h);
            display:flex;
            align-items:center;
            justify-content: space-between;
            gap: 14px;
        ...
        .cc-appbar > * { position: relative; z-index: 1; }
        ...
        body.dark-mode .cc-back{ background: rgba(2,6,23,.36); }
        .cc-back:hover{
            transform: translateY(-1px);
            border-color: rgba(56,189,248,.45);
        ...
        body.dark-mode .cc-ico{ background: rgba(2,6,23,.38); border-color: rgba(129,140,248,.28); }
        .cc-ico:hover{
            transform: translateY(-1px);
            border-color: rgba(56,189,248,.55);
        ...
        .cc-shell{
            margin-top: 14px;
            height: calc(100% - (var(--cc-appbar-h) + 14px));
        ...
        .cc-grid{
            ...
            flex: 1;
            min-height: 0; /* IMPORTANT: allows inner scroll areas to work */
        }
        ...
        .cc-shell.cc-overlay-on .cc-overlay{
            opacity: 1;
            pointer-events:auto;
        }
        ...
        body.dark-mode .cc-brand{ background: rgba(2,6,23,.30); }
        ...
        .cc-dot{
            ...
            border-radius: 999px;
            background: radial-gradient(circle at 30% 30%, #fef9c3, var(--cc-accent) 55%, var(--cc-indigo));
        ...
        body.dark-mode .cc-search{ background: rgba(2,6,23,.32); }
        ...
        .cc-search input::placeholder{ color: rgba(15,23,42,.45); }
        body.dark-mode .cc-search input::placeholder{ color: rgba(229,231,235,.45); }
        ...
        /* nicer scrollbars */
        .cc-channels, .cc-body, .cc-members{
            scrollbar-width: thin;
            scrollbar-color: rgba(56,189,248,.45) rgba(148,163,184,.18);
        }
        .cc-channels::-webkit-scrollbar,
        .cc-body::-webkit-scrollbar,
        .cc-members::-webkit-scrollbar{
            width: 10px;
        }
        .cc-channels::-webkit-scrollbar-thumb,
        .cc-body::-webkit-scrollbar-thumb,
        .cc-members::-webkit-scrollbar-thumb{
            background: linear-gradient(180deg, rgba(56,189,248,.55), rgba(79,70,229,.30));
            border-radius: 999px;
            border: 2px solid rgba(255,255,255,.25);
        }
        body.dark-mode .cc-channels::-webkit-scrollbar-thumb,
        body.dark-mode .cc-body::-webkit-scrollbar-thumb,
        body.dark-mode .cc-members::-webkit-scrollbar-thumb{
        ...
        body.dark-mode .cc-channel{ background: rgba(2,6,23,.24); }
        ...
        .cc-channel.active{
            border-color: rgba(56,189,248,.55);
            background: linear-gradient(135deg, rgba(56,189,248,.18), rgba(79,70,229,.12));
        ...
        .cc-hash{
            ...
            display:grid;
            place-items:center;
            background: radial-gradient(circle at 30% 10%, rgba(254,249,195,.90), rgba(56,189,248,.55), rgba(79,70,229,.45));
        ...
        .cc-chan-ic{
            ...
            display:grid;
            place-items:center;
            background: linear-gradient(135deg, rgba(56,189,248,.22), rgba(79,70,229,.14));
        ...
        .cc-body{
            ...
            background:
                radial-gradient(900px 420px at 18% 10%, rgba(56,189,248,.10), transparent 60%),
                radial-gradient(900px 420px at 86% 18%, rgba(79,70,229,.08), transparent 62%);
        }
        ...
        body.dark-mode .cc-load{ background: rgba(2,6,23,.35); }
        .cc-load:hover{ transform: translateY(-1px); border-color: rgba(56,189,248,.45); }
        ...
        body.dark-mode .cc-msg:hover{ background: rgba(2,6,23,.24); }
        ...
        .cc-msg-main{ min-width: 0; width: 100%; }
        ...
        .cc-prev-item img, .cc-prev-item video{
            width:100%;
            height:100%;
            object-fit: cover;
            display:block;
        ...
        body.dark-mode .cc-tool{ background: rgba(2,6,23,.38); border-color: rgba(129,140,248,.28); }
        .cc-tool:hover{ transform: translateY(-1px); border-color: rgba(56,189,248,.55); }
        ...
        body.dark-mode .cc-input{ background: rgba(2,6,23,.34); border-color: rgba(129,140,248,.28); }
        .cc-input:focus{
        ...
        .cc-send:hover{ filter: brightness(1.07); transform: translateY(-1px); }
        ...
        body.dark-mode .cc-em{ background: rgba(2,6,23,.24); }
        .cc-em:hover{ border-color: rgba(56,189,248,.45); background: rgba(56,189,248,.10); }
        ...
        body.dark-mode .cc-member{ background: rgba(2,6,23,.24); }
        .cc-member:hover{ transform: translateY(-1px); border-color: rgba(56,189,248,.32); }
        ...
        .cc-pres.off{ background: var(--cc-red); box-shadow: 0 0 10px rgba(239,68,68,.35); }
        ...
        .cc-toast{
            ...
            transform: translateY(-6px);
            opacity: 0;
            animation: ccToastIn .18s ease-out forwards;
        }
        @keyframes ccToastIn{ to{ opacity: 1; transform: translateY(0); } }
        .cc-toast b{ color: var(--cc-text); }
        .cc-toast p{ margin: 4px 0 0; color: var(--cc-muted); font-size: .9rem; }

        /* Mobile: turn side panes into drawers + keep chat usable */
        .cc-mob-only{ display:none; }
        @media (max-width: 1080px){
            .cc-grid{ grid-template-columns: 300px 1fr; }
            .cc-right{ display:none; }
        }
        @media (max-width: 860px){
            .cc-mob-only{ display:grid; }
            ...
            .cc-shell.cc-open-left .cc-left{ display:flex; }
            .cc-shell.cc-open-right .cc-right{ display:flex; }
            .cc-shell.cc-open-left .cc-overlay,
            .cc-shell.cc-open-right .cc-overlay{
                opacity: 1;
                pointer-events:auto;
            }
        }

        /* ====== PRO APPBAR (taller + unique) ====== */
.cc-appbar{
  height: 84px;                 /* bigger height */
  padding: 14px 16px;
  display:flex;
  align-items:center;
  justify-content:space-between;
  ...
  /* 🔻 REMOVED sticky positioning so it scrolls normally 🔻 */
  /* position: sticky; */
  /* top: 0; */
  z-index: 50;
  ...
  /* glass + subtle aurora */
  background:
    radial-gradient(1200px 140px at 15% 0%, rgba(56,189,248,.22), transparent 60%),
    radial-gradient(900px 160px at 85% 10%, rgba(99,102,241,.18), transparent 55%),
    linear-gradient(135deg, rgba(255,255,255,.88), rgba(226,232,240,.78));
  backdrop-filter: blur(18px);
  -webkit-backdrop-filter: blur(18px);
...
body.dark-mode .cc-appbar{
  border-color: rgba(37,99,235,.55);
  background:
    radial-gradient(1200px 140px at 15% 0%, rgba(56,189,248,.18), transparent 60%),
    radial-gradient(900px 160px at 85% 10%, rgba(99,102,241,.16), transparent 55%),
    linear-gradient(135deg, rgba(15,23,42,.86), rgba(2,6,23,.86));
  box-shadow:
    0 26px 80px rgba(0,0,0,.72),
    inset 0 0 0 1px rgba(30,64,175,.22);
}

/* ====== Back link: premium pill ====== */
.cc-back{
  display:flex;
  align-items:center;
  gap: 10px;
  ...
  box-shadow: 0 14px 34px rgba(15,23,42,.10), inset 0 0 0 1px rgba(255,255,255,.52);

  transition: transform .18s ease, box-shadow .18s ease, border-color .18s ease, background .18s ease;
}
body.dark-mode .cc-back{
  background: rgba(2,6,23,.32);
  border-color: rgba(129,140,248,.25);
  box-shadow: 0 18px 50px rgba(0,0,0,.65), inset 0 0 0 1px rgba(30,64,175,.20);
}
...
.cc-back:hover{
  transform: translateY(-1px);
  border-color: rgba(191,219,254,.95);
  box-shadow: 0 20px 52px rgba(15,23,42,.16), inset 0 0 0 1px rgba(255,255,255,.68);
}
...
.cc-ico{
  ...
  border: 1px solid rgba(148,163,184,.55);
  background: linear-gradient(135deg, rgba(255,255,255,.86), rgba(226,232,240,.78));
  box-shadow: 0 16px 40px rgba(15,23,42,.12), inset 0 0 0 1px rgba(255,255,255,.62);
...
body.dark-mode .cc-ico{
  border-color: rgba(37,99,235,.55);
  background: linear-gradient(135deg, rgba(15,23,42,.80), rgba(2,6,23,.86));
  box-shadow: 0 22px 60px rgba(0,0,0,.70), inset 0 0 0 1px rgba(30,64,175,.26);
}
...
.cc-ico:hover{
  transform: translateY(-1px);
  border-color: rgba(191,219,254,.95);
  box-shadow: 0 20px 52px rgba(15,23,42,.18), inset 0 0 0 1px rgba(255,255,255,.72);
}
.cc-ico:hover::after{ opacity: .70; }

/* ====== Responsive: keep it clean on small screens ====== */
@media (max-width: 720px){
  .cc-appbar{ height: 76px; padding: 12px 12px; border-radius: 20px; }
  .cc-app-sub{ max-width: 34ch; }
  .cc-back span{ display:none; }  /* icon-only back */
  .cc-back{ padding: 10px; }
}
...
<div class="profile-actions" style="justify-content: flex-end;">
    <form method="POST" action="{{ url('/logout') }}" class="profile-logout">
        ...
        <div class="cc-wrap">
            ...
            {{-- Top Appbar (NEW): back to dashboard + title + notify + mobile toggles --}}
            <div class="cc-appbar">
                <a class="cc-back" href="{{ url('/dashboard') }}" title="Back to Dashboard">
                    <i class="fa-solid fa-arrow-left"></i>
                    <span>Dashboard</span>
                </a>

                <div class="cc-appbar-mid">
                    <div class="cc-app-title">Cogni Connect</div>
                    <div class="cc-app-sub">Realtime community chat • Images • Videos • Emojis</div>
                </div>

                <div class="cc-appbar-actions">


                    {{-- Notifications permission --}}
                    <button class="cc-ico" type="button" id="ccAskNotify" title="Enable browser notifications">
                        <i class="fa-solid fa-bell"></i>
                    </button>
                </div>
            </div>

            <div class="cc-shell" id="ccShell">
                <div class="cc-overlay" id="ccOverlay"></div>

                <div class="cc-grid">

                    {{-- LEFT: Channels --}}
                    <aside class="cc-left" id="ccLeftPane">
                        <div class="cc-brand">
                            <div class="cc-brand-title">
                                <span class="cc-dot"></span>
                                Channels
                            </div>
                            <div style="color:var(--cc-muted);font-weight:900">{{ count($channels) }}</div>
                        </div>

                        <div class="cc-search">
                            <i class="fa-solid fa-magnifying-glass" style="opacity:.8"></i>
                            <input id="ccChannelSearch" type="text" placeholder="Search channels…">
                        </div>

                        <div class="cc-section">
                            <span>All Channels</span>
                            <span style="opacity:.7">{{ count($channels) }}</span>
                        </div>

                        <div class="cc-channels" id="ccChannels">
                            @foreach($channels as $ch)
                                @php
                                    $isActive = $active->id === $ch->id;
                                    $uc = (int)($unread[$ch->id] ?? 0);
                                @endphp

                                <a class="cc-channel {{ $isActive ? 'active' : '' }}"
                                   href="{{ route('cogni.connect', ['slug' => $ch->slug]) }}"
                                   data-id="{{ $ch->id }}"
                                   data-slug="{{ $ch->slug }}"
                                   data-name="{{ strtolower($ch->name) }}">
                                    <div class="cc-channel-left">
                                        <span class="cc-hash"><i class="fa-solid fa-hashtag"></i></span>
                                        <div class="cc-channel-name"># {{ $ch->name }}</div>
                                    </div>
                                    @if($uc > 0)
                                        <span class="cc-badge">{{ $uc }}</span>
                                    @endif
                                </a>
                            @endforeach
                        </div>
                    ...
                    <main class="cc-mid">
                        <header class="cc-top">
                            <div class="cc-top-left">
                                <div class="cc-chan-ic">
                                    <i class="fa-solid fa-comments"></i>
                                </div>
                                <div class="cc-top-title">
                                    <h2># {{ $active->name }}</h2>
                                    <p>{{ $active->description ?? 'Cognisense community channel.' }}</p>
                                </div>
                            </div>

                            <div class="cc-top-actions">
                                <button class="cc-ico" type="button" id="ccScrollBottom" title="Jump to latest">
                                    <i class="fa-solid fa-arrow-down"></i>
                                </button>
                                <button class="cc-ico" type="button" id="ccRefresh" title="Refresh messages">
                        ...
                        <div class="cc-body" id="ccBody">
                            <button class="cc-load" id="ccLoadMore" type="button">Load earlier</button>
                            ...
                            @foreach($messages as $m)
                                @php
                                    ...
                                    $time = optional($m->created_at)->timezone('Asia/Dhaka')->format('d M, h:i A');
                                    $atts = $m->attachments ?? collect();
                                @endphp

                                <div class="cc-msg" data-id="{{ $m->id }}">
                                    ...
                                    <div class="cc-msg-main">
                                        ...
                                        @if(!empty($m->body))
                                            <div class="cc-text">{{ $m->body }}</div>
                                        @endif

                                        @if($atts->count() > 0)
                                            <div class="cc-attach-grid">
                                                @foreach($atts as $a)
                                                    @php
                                                        $mime = $a->mime ?? '';
                                                    ...
                                                    <div class="cc-attach">
                                                        ...
                                                        @else
                                                            <div style="padding:16px;color:rgba(15,23,42,.7)">
                                                                File: {{ $a->original_name }}
                                                            </div>
                                                        @endif
                                                        <div class="cc-attach-meta">
                                                            <span style="overflow:hidden;text-overflow:ellipsis;white-space:nowrap">{{ $a->original_name }}</span>
                                                            <span>{{ round(($a->size ?? 0)/1024) }} KB</span>
                                                        </div>
                                                    </div>
                                                @endforeach
                                            </div>
                        ...
                        {{-- Composer --}}
                        <section class="cc-compose" style="position:relative">
                            <div class="cc-preview" id="ccPreview"></div>

                            <div class="cc-emoji" id="ccEmoji">
                                <div class="cc-emoji-head">
                                    <b>Emojis</b>
                                    <button class="cc-ico" type="button" id="ccEmojiClose" style="width:40px;height:40px">
                                        <i class="fa-solid fa-xmark"></i>
                                    </button>
                                </div>
                                <div class="cc-emoji-grid" id="ccEmojiGrid"></div>
                            </div>

                            <div class="cc-compose-row">
                                <div class="cc-tools">
                                    <button class="cc-tool" type="button" id="ccEmojiBtn" title="Emoji">
                                        <i class="fa-regular fa-face-smile"></i>
                                    </button>

                                    <button class="cc-tool" type="button" id="ccFileBtn" title="Upload image/video">
                                        <i class="fa-solid fa-paperclip"></i>
                                    </button>
                                    <input id="ccFiles" type="file" multiple hidden
                                           accept="image/*,video/mp4,video/webm,video/quicktime,video/x-m4v">
                                </div>

                                <textarea class="cc-input" id="ccInput"
                                          placeholder="Message #{{ $active->name }} (Enter to send, Shift+Enter new line)"></textarea>

                                <button class="cc-send" type="button" id="ccSend" title="Send">
                    ...
                    {{-- RIGHT: Members --}}
                    <aside class="cc-right" id="ccRightPane">
                        <div class="cc-brand">
                            <div class="cc-brand-title">
                                <span class="cc-dot"></span>
                                Members
                            </div>
                            <div style="color:var(--cc-muted);font-weight:900">{{ count($members) }}</div>
                        </div>
                        ...
                        <div class="cc-members">
                            @foreach($members as $u)
                                @php
                                    ...
                                    $on = (int)($u->is_active ?? 1) === 1;
                                @endphp
                                <div class="cc-member">
                                    <div class="cc-member-left">
                                        <div class="cc-mini">{{ $ini }}</div>
                                        <div style="min-width:0">
                                            <div class="cc-member-name">{{ $nm }}</div>
                                            <div class="cc-member-mail">{{ $u->email }}</div>
                                        </div>
                                    </div>
                                    <span class="cc-pres {{ $on ? '' : 'off' }}"></span>
                                </div>
                            @endforeach
                        </div>
                    </aside>
    ...
    {{-- Toast container --}}
    <div class="cc-toasts" id="ccToasts"></div>
...
<div class="cs-chat-title cs-chat-brand">
 ...
 <div class="cs-msg bot">
  ...
  Ask me anything about Cognisense<br>
...
(() => {
  ...
  const ensureEcho = () => {
    ...
    const EchoCtor =
      ...
      window.LaravelEcho ||
      (window.Echo && window.Echo.default) ||
      window.Echo;
    ...
    // Use window.location.hostname so the browser always connects to the correct host
  ...
  updateBadges();
    ...
    {{-- Realtime libraries already loaded above (pusher + echo) - removed duplicate --}}

    <script>
/**
 * Cogni Connect — Frontend (Discord-style)
 * - Realtime via Pusher private channels
 * - Send text + image/video
 * - Emoji picker
 * - Load earlier messages
 * - Mark read (debounced)
 * - In-app toast + optional browser notifications
 *
 * ✅ Logic unchanged. Only added small mobile drawer toggles at the top (non-breaking).
 */
(() => {
  const csrf = document.querySelector('meta[name="csrf-token"]')?.getAttribute('content') || '';
  const tz = 'Asia/Dhaka';
  ...
  const ACTIVE_CHANNEL_ID = Number(@json($active->id));
  const ACTIVE_CHANNEL_SLUG = String(@json($active->slug));
  const AUTH_USER_ID = Number(@json(auth()->id()));
  ...
  // Endpoints for the currently open channel
  const URLS = {
    list: @json(route('cogni.connect.messages', ['channel' => $active->id])),
    send: @json(route('cogni.connect.send', ['channel' => $active->id])),
    read: @json(route('cogni.connect.read', ['channel' => $active->id])),
    channelBase: @json(url('/cogni-connect')),
    authEndpoint: @json(url('/broadcasting/auth')),
  };

  // DOM
  const ccBody = document.getElementById('ccBody');
  const loadBtn = document.getElementById('ccLoadMore');
  const input = document.getElementById('ccInput');
  const sendBtn = document.getElementById('ccSend');
  const fileBtn = document.getElementById('ccFileBtn');
  const filesInput = document.getElementById('ccFiles');
  const previewWrap = document.getElementById('ccPreview');

  const emojiBtn = document.getElementById('ccEmojiBtn');
  const emojiBox = document.getElementById('ccEmoji');
  const emojiGrid = document.getElementById('ccEmojiGrid');
  const emojiClose = document.getElementById('ccEmojiClose');

  const scrollBottomBtn = document.getElementById('ccScrollBottom');
  const refreshBtn = document.getElementById('ccRefresh');
  const channelSearch = document.getElementById('ccChannelSearch');

  const toasts = document.getElementById('ccToasts');
  const askNotifyBtn = document.getElementById('ccAskNotify');

  // Mobile drawer toggles (non-breaking)
  const ccShell = document.getElementById('ccShell');
  const ccOverlay = document.getElementById('ccOverlay');
  const btnToggleLeft = document.getElementById('ccToggleLeft');
  const btnToggleRight = document.getElementById('ccToggleRight');

  const closeDrawers = () => {
    if (!ccShell) return;
    ccShell.classList.remove('cc-open-left', 'cc-open-right', 'cc-overlay-on');
  };
  const openLeft = () => {
    if (!ccShell) return;
    ccShell.classList.add('cc-open-left', 'cc-overlay-on');
    ccShell.classList.remove('cc-open-right');
  };
  const openRight = () => {
    if (!ccShell) return;
    ccShell.classList.add('cc-open-right', 'cc-overlay-on');
    ccShell.classList.remove('cc-open-left');
  };

  if (btnToggleLeft) btnToggleLeft.addEventListener('click', () => {
    if (!ccShell) return;
    const isOpen = ccShell.classList.contains('cc-open-left');
    isOpen ? closeDrawers() : openLeft();
  });
  if (btnToggleRight) btnToggleRight.addEventListener('click', () => {
    if (!ccShell) return;
    const isOpen = ccShell.classList.contains('cc-open-right');
    isOpen ? closeDrawers() : openRight();
  });
  if (ccOverlay) ccOverlay.addEventListener('click', closeDrawers);

  // Close drawers when user clicks a channel (mobile)
  document.addEventListener('click', (e) => {
    const a = e.target?.closest?.('.cc-channel');
    if (a) closeDrawers();
  });

  if (!ccBody || !input || !sendBtn) return;
  ...
  const isAtBottom = () => {
    ...
    return (ccBody.scrollHeight - ccBody.scrollTop - ccBody.clientHeight) < threshold;
  };

  const scrollToBottom = (smooth = true) => {
    ccBody.scrollTo({ top: ccBody.scrollHeight, behavior: smooth ? 'smooth' : 'auto' });
  };

  const toast = (title, message, onClick = null) => {
    const t = document.createElement('div');
    t.className = 'cc-toast';
    t.innerHTML = `<b></b><p></p>`;
    t.querySelector('b').textContent = title || 'Notification';
  ...
  // Browser notifications (works while site is open)
  const browserNotify = (title, body, url) => {
    try {
  ...
  // -------- Sidebar unread badge bump
  const bumpUnread = (channelId, inc = 1) => {
    const link = document.querySelector(`.cc-channel[data-id="${channelId}"]`);
    if (!link) return;
    if (link.classList.contains('active')) return;

    let badge = link.querySelector('.cc-badge');
    const cur = badge ? Number(badge.textContent || 0) : 0;
  ...
  const renderPreview = () => {
    ...
    files.forEach((f, idx) => {
      ...
      item.className = 'cc-prev-item';

      const x = document.createElement('div');
      x.className = 'cc-prev-x';
      x.innerHTML = '<i class="fa-solid fa-xmark"></i>';
      x.addEventListener('click', () => {
        const next = new DataTransfer();
        files.forEach((file, i) => { if (i !== idx) next.items.add(file); });
        dt = next;
  ...
  // -------- Message DOM builder (XSS-safe: uses textContent)
  const buildAttachmentNode = (att) => {
    const wrap = document.createElement('div');
    wrap.className = 'cc-attach';
    ...
    if (mime.startsWith('image/')) {
      ...
      box.style.color = 'rgba(15,23,42,.7)';
      box.textContent = `File: ${att.original_name || 'attachment'}`;
      wrap.appendChild(box);
    }

    const meta = document.createElement('div');
    meta.className = 'cc-attach-meta';

    const left = document.createElement('span');
    left.style.overflow = 'hidden';
    left.style.textOverflow = 'ellipsis';
    left.style.whiteSpace = 'nowrap';
    left.textContent = att.original_name || 'attachment';

    const right = document.createElement('span');
    const kb = Math.round((Number(att.size || 0)) / 1024);
    right.textContent = `${kb} KB`;
  ...
  const buildMessageNode = (m) => {
    ...
    const nm = (m.user && (m.user.full_name || m.user.name))
      ? (m.user.full_name || m.user.name)
      : 'User';
    av.textContent = initials(nm);

    const main = document.createElement('div');
    main.className = 'cc-msg-main';

    const head = document.createElement('div');
    head.className = 'cc-msg-head';
    ...
    if (atts.length > 0) {
      ...
      atts.forEach(a => grid.appendChild(buildAttachmentNode(a)));
  ...
  const appendMessage = (m, { forceScroll = false } = {}) => {
    if (!m || !m.id) return;
    if (ccBody.querySelector(`.cc-msg[data-id="${m.id}"]`)) return;

    const shouldAuto = forceScroll || isAtBottom();
    const node = buildMessageNode(m);
    ccBody.appendChild(node);

    if (shouldAuto) scrollToBottom(true);
  };

  const prependMessages = (messages) => {
    if (!Array.isArray(messages) || messages.length === 0) return;

    const beforeHeight = ccBody.scrollHeight;
    const beforeTop = ccBody.scrollTop;

    const anchor = loadBtn?.nextSibling;
    messages.forEach(m => {
      if (ccBody.querySelector(`.cc-msg[data-id="${m.id}"]`)) return;
      const node = buildMessageNode(m);
      ccBody.insertBefore(node, anchor);
    });

    const afterHeight = ccBody.scrollHeight;
    ccBody.scrollTop = beforeTop + (afterHeight - beforeHeight);
  };

  const getFirstMessageId = () => {
    const first = ccBody.querySelector('.cc-msg');
    return first ? Number(first.dataset.id || 0) : 0;
  };

  const getLastMessageId = () => {
    const msgs = ccBody.querySelectorAll('.cc-msg');
  ...
  const markReadDebounced = () => {
    ...
    readTimer = setTimeout(async () => {
      ...
      try {
        ...
        const badge = document.querySelector(`.cc-channel.active .cc-badge`);
        if (badge) badge.remove();
      } catch {}
    }, 650);
  };
  ...
  ccBody.addEventListener('scroll', () => {
    if (isAtBottom()) markReadDebounced();
  });

  document.addEventListener('visibilitychange', () => {
    if (!document.hidden && isAtBottom()) markReadDebounced();
  });
  ...
  const loadOlder = async () => {
    ...
    const before = getFirstMessageId();
    try {
      ...
      if (msgs.length === 0) {
        ...
        toast('All caught up', 'No earlier messages found.');
      } else {
        prependMessages(msgs);
        if (msgs.length < 50 && loadBtn) loadBtn.style.display = 'none';
      }
    } catch {
  ...
  const initialCount = ccBody.querySelectorAll('.cc-msg').length;
  if (initialCount < 50 && loadBtn) loadBtn.style.display = 'none';
  ...
  const refreshLatest = async () => {
    try {
      ...
      ccBody.querySelectorAll('.cc-msg').forEach(n => n.remove());
      if (loadBtn) loadBtn.style.display = 'block';

      msgs.forEach(m => appendMessage(m, { forceScroll: false }));
      if (msgs.length < 50 && loadBtn) loadBtn.style.display = 'none';

      scrollToBottom(false);
      markReadDebounced();
      toast('Refreshed', 'Latest messages loaded.');
    } catch {
  ...
  const sendMessage = async () => {
    ...
    if (!body.trim() && files.length === 0) {
      toast('Empty', 'Write something or attach a file.');
      return;
    }
    ...
    try {
      ...
      if (!res.ok || !data || data.ok !== true) {
        const msg = (data && (data.error || data.message)) ? (data.error || data.message) : 'Failed to send.';
  ...
  input.addEventListener('keydown', (e) => {
    ...
    if (e.key === 'Escape') {
      if (emojiBox && emojiBox.style.display === 'block') emojiBox.style.display = 'none';
      closeDrawers();
    }
  });
  ...
  const grow = () => {
    input.style.height = '46px';
    const h = Math.min(input.scrollHeight, 160);
  ...
  // Optional: drag & drop onto composer
  const composer = document.querySelector('.cc-compose');
  if (composer && filesInput) {
    composer.addEventListener('dragover', (e) => { e.preventDefault(); composer.style.outline = '2px dashed rgba(56,189,248,.55)'; });
    composer.addEventListener('dragleave', () => { composer.style.outline = 'none'; });
  ...
  if (emojiClose) emojiClose.addEventListener('click', () => {
    if (emojiBox) emojiBox.style.display = 'none';
  });

  document.addEventListener('click', (e) => {
    if (!emojiBox) return;
    if (emojiBox.style.display !== 'block') return;

    const t = e.target;
    if (emojiBox.contains(t)) return;
    if (emojiBtn && emojiBtn.contains(t)) return;
  ...
  if (channelSearch) {
    channelSearch.addEventListener('input', () => {
      ...
      document.querySelectorAll('#ccChannels .cc-channel').forEach(a => {
        const name = String(a.getAttribute('data-name') || '');
  ...
  if (askNotifyBtn) {
    askNotifyBtn.addEventListener('click', async () => {
      if (!('Notification' in window)) {
        toast('Unsupported', 'Browser notifications are not supported here.');
        return;
      }
      if (Notification.permission === 'granted') {
        toast('Enabled', 'Browser notifications already enabled.');
        return;
      }
      const perm = await Notification.requestPermission();
      if (perm === 'granted') toast('Enabled', 'Browser notifications enabled.');
      else toast('Disabled', 'Browser notifications were not enabled.');
    });
  }
  ...
  const ensureEcho = () => {
    ...
    if (!EchoCtor) {
      toast('Realtime disabled', 'Echo library not found.');
      return null;
    }

    // Make sure Pusher global exists (Echo uses pusher-js under the hood even for Reverb)
    if (!window.Pusher && typeof Pusher !== 'undefined') window.Pusher = Pusher;

    // Detect driver from backend
    const BROADCAST_DRIVER = @json(config('broadcasting.default')); // 'reverb' or 'pusher' etc.

    // Reverb envs (safe defaults)
    const REVERB_KEY = @json(env('REVERB_APP_KEY', ''));
    // Use window.location.hostname so the browser always connects to the correct host
    const REVERB_HOST = window.location.hostname;
    const REVERB_PORT = Number(@json(env('REVERB_PORT', 8080)));
    ...
    // Guard: missing key
    if (BROADCAST_DRIVER === 'reverb' && !REVERB_KEY) {
      toast('Realtime misconfigured', 'REVERB_APP_KEY is missing in .env');
      return null;
    }
    if (BROADCAST_DRIVER === 'pusher' && !PUSHER_KEY) {
      toast('Realtime misconfigured', 'PUSHER_APP_KEY is missing in .env');
      return null;
    }
    ...
    const echo = new EchoCtor({
      ...
      authEndpoint: URLS.authEndpoint,
      auth: { headers: { 'X-CSRF-TOKEN': csrf } },
    });
  ...
  echo.private(`cogni-connect.channel.${ACTIVE_CHANNEL_ID}`)
    .listen('.cc.message', (payload) => {
      const msg = payload;
  ...
  echo.private(`App.Models.User.${AUTH_USER_ID}`)
    .notification((n) => {
      ...
      const channelId = Number(n.channel_id || 0);
      const channelSlug = String(n.channel_slug || '');
      const channelName = String(n.channel_name || 'Channel');
      const fromName = String(n.from_name || 'User');
      const preview = String(n.preview || '');

      const targetUrl = `${URLS.channelBase}/${channelSlug}`;

      if (channelId === ACTIVE_CHANNEL_ID) {
        if (!isAtBottom()) {
          toast(`# ${channelName}`, `${fromName}: ${preview}`, () => scrollToBottom(true));
        }
        return;
      }

      bumpUnread(channelId, 1);

      toast(`# ${channelName}`, `${fromName}: ${preview}`, () => {
        window.location.href = targetUrl;
      });

      browserNotify(`Cogni Connect • #${channelName}`, `${fromName}: ${preview}`, targetUrl);
    });

  // -------- Smart Polling (cross-device fallback — works even when Reverb is on localhost)
  // Polls every 5 seconds for new messages AFTER the last known message ID.
  // Echo handles real-time on the same machine; polling bridges cross-device gaps.
  let polling = true;
  ...
  const pollNewMessages = async () => {
    ...
    try {
      const lastId = getLastMessageId();
      const url = new URL(URLS.list, window.location.origin);
      if (lastId > 0) url.searchParams.set('after', String(lastId));
      ...
      msgs.forEach(m => {
        if (m.id > lastId) {
          appendMessage(m, { forceScroll: false });
          appended = true;
        }
      });
    ...
    } catch { /* silent — network hiccups are fine */ }
  };

  const pollInterval = setInterval(pollNewMessages, 5000);

  // Stop polling when user navigates away (cleanup)
