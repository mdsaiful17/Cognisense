...
<head>
    <meta charset="UTF-8">
    <title>Certificate - Cognisense</title>
...
/* ===== Layout ===== */
.cert-wrap{max-width:1100px;margin:24px auto;padding:0 16px;font-family:system-ui,-apple-system,Segoe UI,Roboto,Ubuntu,Cantarell,Noto Sans,sans-serif}
.cert-header{display:flex;gap:16px;justify-content:space-between;align-items:flex-start;flex-wrap:wrap}
.cert-header h1{font-size:34px;letter-spacing:-.02em;margin:0}
/* muted should NOT be white in light mode */
.muted { color: rgba(15,23,42,.62); }
body.dark-mode .muted { color: rgba(229,231,235,.72); }

/* only dark background in dark mode */
body.dark-mode {
  background: #070A12;
  color: #fff;
}
...
/* ===== Cards ===== */
.score-card{min-width:320px;background:linear-gradient(135deg,rgba(255,255,255,.08),rgba(255,255,255,.04));border:1px solid rgba(255,255,255,.10);border-radius:18px;padding:16px;backdrop-filter:blur(10px);box-shadow:0 18px 60px rgba(0,0,0,.45)}
...
.pill.ok{background:rgba(0,255,163,.12);border-color:rgba(0,255,163,.25)}
.pill.warn{background:rgba(255,179,0,.12);border-color:rgba(255,179,0,.25)}
.score{font-size:30px;font-weight:800}
.score small{font-size:14px;color:rgba(255,255,255,.65);margin-left:6px}
.score-top{display:flex;justify-content:space-between;align-items:center}
.score-sub{margin-top:10px;font-size:13px}

/* ===== Existing certificate bar ===== */
.existing{margin-top:18px;display:flex;justify-content:space-between;gap:14px;align-items:center;
background:linear-gradient(135deg,rgba(0,255,163,.12),rgba(255,255,255,.04));
border:1px solid rgba(0,255,163,.22);border-radius:18px;padding:14px 16px}
.existing-actions{display:flex;gap:10px;flex-wrap:wrap}

/* ===== Eligibility ===== */
.eligibility{margin-top:18px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.08);border-radius:18px;padding:16px}
.elig-head{display:flex;justify-content:space-between;gap:12px;flex-wrap:wrap;align-items:center}
...
.skill{border-radius:16px;padding:12px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.08);position:relative;overflow:hidden}
.skill.done{border-color:rgba(0,255,163,.22);background:rgba(0,255,163,.07)}
.skill-top{display:flex;justify-content:space-between;align-items:center}
.skill-id{font-weight:700}
.skill-status{margin-top:10px;font-size:13px;color:rgba(255,255,255,.72)}
.dot{width:10px;height:10px;border-radius:999px;background:rgba(255,255,255,.22)}
.skill.done .dot{background:#00FFA3;box-shadow:0 0 18px rgba(0,255,163,.6)}
.gate{margin-top:14px;border-radius:16px;padding:14px;background:rgba(255,179,0,.08);border:1px solid rgba(255,179,0,.20)}

/* ===== 3D Apply ===== */
.apply-area{margin-top:18px;display:grid;grid-template-columns:1.3fr .7fr;gap:14px}
@media(max-width:980px){.apply-area{grid-template-columns:1fr}}
...
.form-3d-inner{
transform-style:preserve-3d;
background:radial-gradient(1000px 600px at 10% 10%, rgba(113,63,255,.25), transparent 55%),
           radial-gradient(900px 600px at 90% 30%, rgba(0,255,163,.18), transparent 50%),
           rgba(255,255,255,.04);
...
.form-title h2{margin:10px 0 6px 0;font-size:24px}
.badge{display:inline-flex;font-weight:800;letter-spacing:.12em;font-size:11px;text-transform:uppercase;padding:6px 10px;border-radius:999px;
background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.10)}

.alert{margin:12px 0;padding:12px 14px;border-radius:14px;background:rgba(255,79,79,.10);border:1px solid rgba(255,79,79,.22)}
.alert ul{margin:8px 0 0 18px}

.cert-form{margin-top:14px}
.row{display:grid;grid-template-columns:1fr 1fr;gap:12px}
@media(max-width:700px){.row{grid-template-columns:1fr}}
.field label{display:block;font-size:12px;color:rgba(255,255,255,.70);margin:0 0 6px}
.field input{
...
.field input:focus{border-color:rgba(113,63,255,.55);box-shadow:0 0 0 4px rgba(113,63,255,.15)}

.note{margin-top:12px;display:flex;gap:10px;align-items:flex-start;background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.10);border-radius:16px;padding:12px}
.note-icon{width:28px;height:28px;border-radius:10px;display:grid;place-items:center;background:rgba(0,255,163,.14);border:1px solid rgba(0,255,163,.25)}
.note-text{font-size:13px;color:rgba(255,255,255,.72)}

.actions{margin-top:14px;display:flex;gap:12px;align-items:center;flex-wrap:wrap}
.btn{display:inline-flex;align-items:center;justify-content:center;gap:10px;padding:10px 14px;border-radius:14px;border:1px solid rgba(255,255,255,.12);
background:rgba(255,255,255,.06);color:#fff;text-decoration:none;font-weight:700;cursor:pointer}
...
/* Preview */
.preview-card{border-radius:22px;padding:16px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.08)}
.preview-mock{margin-top:12px;border-radius:18px;padding:14px;background:rgba(0,0,0,.25);border:1px solid rgba(255,255,255,.08)}
.mock-logo{width:120px;height:26px;border-radius:10px;background:rgba(255,255,255,.10)}
.mock-title{margin-top:12px;height:18px;width:70%;border-radius:10px;background:rgba(255,255,255,.10)}
.mock-lines{margin-top:10px;height:10px;width:100%;border-radius:10px;background:rgba(255,255,255,.08)}
.mock-lines.short{width:82%}
.mock-footer{margin-top:18px;height:14px;width:55%;border-radius:10px;background:rgba(255,255,255,.08)}

/* =========================================================
   CERTIFICATE PANEL — Light + Dark Theme (SCOPED)
   Drop this near the END of your <style>.
   Works with your existing: body.dark-mode toggle.
   ========================================================= */

/* --- Theme tokens (only used by certificate panel) --- */
:root{
  --cert-text: #0b1120;
  --cert-muted: rgba(15,23,42,.66);

  --cert-surface: linear-gradient(135deg, rgba(255,255,255,.92), rgba(226,232,240,.88));
  --cert-card: rgba(255,255,255,.72);
  --cert-card-2: rgba(255,255,255,.55);

  --cert-border: rgba(148,163,184,.55);
  --cert-border-soft: rgba(148,163,184,.32);
  --cert-shadow: 0 24px 70px rgba(15,23,42,.12);

  --cert-accent: #38bdf8;
  --cert-indigo: #4f46e5;

  --cert-success: #22c55e;
  --cert-success-bg: rgba(34,197,94,.12);
  --cert-warn: #f59e0b;
  --cert-warn-bg: rgba(245,158,11,.14);
  --cert-danger: #ef4444;
  --cert-danger-bg: rgba(239,68,68,.12);

  --cert-input-bg: rgba(255,255,255,.70);
  --cert-input-border: rgba(148,163,184,.40);
  --cert-input-placeholder: rgba(15,23,42,.45);
...
body.dark-mode{
  --cert-text: #e5e7eb;
  --cert-muted: rgba(229,231,235,.70);

  --cert-surface: linear-gradient(135deg, rgba(15,23,42,.96), rgba(2,6,23,.98));
  --cert-card: rgba(15,23,42,.64);
  --cert-card-2: rgba(2,6,23,.42);

  --cert-border: rgba(37,99,235,.60);
  --cert-border-soft: rgba(129,140,248,.22);
  --cert-shadow: 0 30px 90px rgba(0,0,0,.60);

  --cert-success-bg: rgba(34,197,94,.14);
  --cert-warn-bg: rgba(245,158,11,.14);
  --cert-danger-bg: rgba(239,68,68,.12);

  --cert-input-bg: rgba(2,6,23,.48);
  --cert-input-border: rgba(129,140,248,.26);
  --cert-input-placeholder: rgba(229,231,235,.42);
}
...
.cert-wrap .score-card::before{
  content:"";
  position:absolute;
  inset:0;
  background:
    radial-gradient(820px 320px at 18% 10%, rgba(56,189,248,.18), transparent 60%),
    radial-gradient(820px 360px at 85% 14%, rgba(79,70,229,.12), transparent 62%);
  opacity: .9;
  pointer-events:none;
}

.cert-wrap .score-card > *{ position: relative; z-index: 1; }
...
/* =========================================================
   Pills (scoped so it won’t affect your profile pills)
   ========================================================= */
.cert-wrap .pill{
  display:inline-flex;
  align-items:center;
...
.cert-wrap .pill.ok{
  background: var(--cert-success-bg);
  border-color: rgba(34,197,94,.28);
}

.cert-wrap .pill.warn{
  background: var(--cert-warn-bg);
...
.cert-wrap .existing{
  ...
  background: linear-gradient(135deg, rgba(34,197,94,.14), var(--cert-card-2));
...
.cert-wrap .existing h3{
  margin: 0 0 6px;
  color: var(--cert-text);
}

.cert-wrap .existing-actions{
  display:flex;
  gap: 10px;
  flex-wrap: wrap;
}
...
.cert-wrap .eligibility::before{
  content:"";
  position:absolute;
  inset:0;
  background:
    radial-gradient(900px 360px at 14% 8%, rgba(56,189,248,.14), transparent 62%),
    radial-gradient(900px 380px at 88% 16%, rgba(79,70,229,.10), transparent 64%);
  opacity: .9;
  pointer-events:none;
}

.cert-wrap .eligibility > *{ position: relative; z-index: 1; }
...
@media(max-width:980px){ .cert-wrap .grid{ grid-template-columns: repeat(2, minmax(0, 1fr)); } }
@media(max-width:520px){ .cert-wrap .grid{ grid-template-columns: 1fr; } }

.cert-wrap .skill{
  border-radius: 16px;
  padding: 12px;

  background: var(--cert-card-2);
  border: 1px solid var(--cert-border-soft);
...
.cert-wrap .skill::before{
  content:"";
  position:absolute;
  inset:0;
  background:
    radial-gradient(520px 220px at 12% 0%, rgba(56,189,248,.12), transparent 60%),
    radial-gradient(520px 220px at 92% 16%, rgba(79,70,229,.10), transparent 60%);
  opacity: .85;
  pointer-events:none;
}

.cert-wrap .skill > *{ position: relative; z-index: 1; }

.cert-wrap .skill:hover{
  transform: translateY(-2px);
  border-color: rgba(56,189,248,.40);
  box-shadow: 0 20px 50px rgba(15,23,42,.12);
}

.cert-wrap .skill.done{
  border-color: rgba(34,197,94,.30);
  background: linear-gradient(135deg, rgba(34,197,94,.12), var(--cert-card-2));
}
...
.cert-wrap .gate{
  ...
  background: linear-gradient(135deg, rgba(245,158,11,.16), var(--cert-card-2));
...
/* =========================================================
   Apply area layout
   ========================================================= */
.cert-wrap .apply-area{
  margin-top: 18px;
  display:grid;
  grid-template-columns: 1.3fr .7fr;
  gap: 14px;
}
@media(max-width:980px){ .cert-wrap .apply-area{ grid-template-columns: 1fr; } }
...
.cert-wrap .form-3d-inner::before{
  content:"";
  position:absolute;
  inset:0;
  background:
    radial-gradient(900px 520px at 12% 10%, rgba(79,70,229,.16), transparent 62%),
    radial-gradient(900px 520px at 88% 20%, rgba(56,189,248,.14), transparent 64%);
  opacity: .9;
  pointer-events:none;
}

.cert-wrap .form-3d-inner > *{ position: relative; z-index: 1; }

.cert-wrap .form-title h2{
  margin: 10px 0 6px;
  font-size: 24px;
  color: var(--cert-text);
}
...
.cert-wrap .alert{
  ...
  padding: 12px 14px;
  border-radius: 14px;
  background: var(--cert-danger-bg);
  border: 1px solid rgba(239,68,68,.28);
  color: var(--cert-text);
}
.cert-wrap .alert ul{ margin: 8px 0 0 18px; color: var(--cert-muted); }

/* Form rows */
.cert-wrap .cert-form{ margin-top: 14px; }
.cert-wrap .row{
  display:grid;
  grid-template-columns: 1fr 1fr;
  gap: 12px;
}
@media(max-width:700px){ .cert-wrap .row{ grid-template-columns: 1fr; } }

.cert-wrap .field label{
  display:block;
  font-size: 12px;
  color: var(--cert-muted);
  margin: 0 0 6px;
...
.cert-wrap .field input{
  width: 100%;
  padding: 12px 12px;
  border-radius: 14px;

  background: var(--cert-input-bg);
  border: 1px solid var(--cert-input-border);
  color: var(--cert-text);
...
.cert-wrap .field input::placeholder{
  color: var(--cert-input-placeholder);
}

.cert-wrap .field input:focus{
  border-color: rgba(56,189,248,.55);
...
.cert-wrap .btn-glow{
  background: linear-gradient(135deg, rgba(79,70,229,.92), rgba(56,189,248,.70));
  border: 1px solid rgba(255,255,255,.18);
  color: #fff;
  box-shadow: 0 14px 40px rgba(79,70,229,.22), 0 10px 28px rgba(56,189,248,.14);
}
.cert-wrap .btn-glow:hover{ filter: brightness(1.05); }

/* tiny helper */
.cert-wrap .tiny{ font-size: 12px; }

/* =========================================================
   Preview card
   ========================================================= */
.cert-wrap .preview-card{
  border-radius: var(--cert-radius-lg);
  padding: 16px;
...
.cert-wrap .preview-card h3{
  margin: 0 0 8px;
  color: var(--cert-text);
}

.cert-wrap .preview-mock{
  margin-top: 12px;
  border-radius: 18px;
  padding: 14px;
...
body.dark-mode .cert-wrap .preview-mock{
  background: rgba(2,6,23,.42);
}

.cert-wrap .mock-logo,
.cert-wrap .mock-title,
.cert-wrap .mock-lines,
.cert-wrap .mock-footer{
  background: rgba(148,163,184,.22);
  border-radius: 10px;
}
body.dark-mode .cert-wrap .mock-logo,
body.dark-mode .cert-wrap .mock-title,
body.dark-mode .cert-wrap .mock-lines,
body.dark-mode .cert-wrap .mock-footer{
  background: rgba(129,140,248,.18);
}

.cert-wrap .mock-logo{ width: 120px; height: 26px; }
.cert-wrap .mock-title{ margin-top: 12px; height: 18px; width: 70%; }
.cert-wrap .mock-lines{ margin-top: 10px; height: 10px; width: 100%; }
.cert-wrap .mock-lines.short{ width: 82%; }
.cert-wrap .mock-footer{ margin-top: 18px; height: 14px; width: 55%; }

:root{
  --app-bg: linear-gradient(145deg, #e0eaff, #f0f4ff);
  --app-text: #2c3e50;
}
...
/* swap only variables */
body.dark-mode{
  --app-bg: linear-gradient(145deg, #0c0c0c, #050505);
  --app-text: #f1f1f1;
}
...
/* Wide container that adapts to content area width (sidebar open/close) */
.cert-wrap{
  ...
  --grad: linear-gradient(135deg, rgba(99,102,241,.30), rgba(34,211,238,.22), rgba(16,185,129,.18));
  --brand: #6366f1;

  width: min(1480px, 100%);     /* wider than typical */
  margin-inline: auto;
  padding: clamp(14px, 2.2vw, 26px);
}

/* Dark mode tokens */
body.dark-mode .cert-wrap{
  --card: rgba(17,24,39,.62);
  --card2: rgba(17,24,39,.46);
  --text: #e5e7eb;
  --muted: rgba(229,231,235,.66);
  --stroke: rgba(255,255,255,.10);
  --shadow: 0 16px 55px rgba(0,0,0,.45);
  --shadow2: 0 10px 30px rgba(0,0,0,.35);
  --grad: linear-gradient(135deg, rgba(99,102,241,.25), rgba(34,211,238,.16), rgba(16,185,129,.14));
}

/* Typography */
.cert-wrap h1,
.cert-wrap h2,
.cert-wrap h3{ color: var(--text); margin: 0; letter-spacing: -.02em; }
.cert-wrap .muted{ color: var(--muted); }
.cert-wrap .tiny{ font-size: 12px; }
...
.score-top{ display:flex; align-items:center; justify-content:space-between; gap: 12px; position:relative; }
.pill{
  display:inline-flex;
  align-items:center;
  gap: 8px;
...
body.dark-mode .pill{ background: rgba(17,24,39,.35); }
...
.score-sub{ position:relative; }

/* Existing certificate callout */
.existing{
  display:flex;
  justify-content:space-between;
  align-items:center;
...
.existing::before{
  content:"";
  position:absolute; inset:-2px;
  background: linear-gradient(90deg, rgba(16,185,129,.20), rgba(34,211,238,.14), rgba(99,102,241,.10));
  filter: blur(18px);
  opacity: .55;
  pointer-events:none;
}
.existing > *{ position:relative; }
.existing-actions{ display:flex; gap: 10px; flex-wrap:wrap; }
...
body.dark-mode .progress .bar{ background: rgba(255,255,255,.06); }

.progress .bar::before{
  content:"";
  position:absolute; inset:0;
  width: var(--pct);
  background: linear-gradient(90deg, rgba(99,102,241,.95), rgba(34,211,238,.95), rgba(16,185,129,.92));
  border-radius: 999px;
  box-shadow: 0 10px 26px rgba(34,211,238,.22);
}

/* Skills grid – modern tiles */
.grid{
  display:grid;
...
.skill.done .dot{
  background: radial-gradient(circle at 30% 30%, #fff, rgba(16,185,129,.95));
  border-color: rgba(16,185,129,.40);
  box-shadow: 0 0 0 6px rgba(16,185,129,.16);
}
.skill.todo .dot{
  background: radial-gradient(circle at 30% 30%, #fff, rgba(245,158,11,.92));
...
.skill.done .skill-status{ color: rgba(16,185,129,.92); }
.skill.todo .skill-status{ color: rgba(245,158,11,.92); }
...
.gate{
  ...
  background: linear-gradient(135deg, rgba(245,158,11,.12), rgba(99,102,241,.06));
}

/* Apply area – wide and clean */
.apply-area{
  margin-top: 18px;
  display:grid;
...
body.dark-mode .field input{ background: rgba(17,24,39,.40); }
...
.note{
  ...
  background: linear-gradient(135deg, rgba(34,211,238,.10), rgba(99,102,241,.06));
  padding: 12px;
  display:flex;
  gap: 10px;
  align-items:flex-start;
...
.note-text{ color: var(--muted); font-weight: 700; line-height: 1.4; }

/* Buttons (keep yours if already existing) */
.btn{
  display:inline-flex;
  align-items:center;
  justify-content:center;
...
body.dark-mode .btn{ background: rgba(17,24,39,.35); }
...
.btn-glow{
  background: linear-gradient(90deg, rgba(99,102,241,.95), rgba(34,211,238,.90));
  color: #fff;
  border-color: rgba(99,102,241,.35);
  box-shadow: 0 18px 40px rgba(99,102,241,.20);
}
.btn-glow:hover{
  box-shadow: 0 22px 55px rgba(34,211,238,.24);
}
...
.mock-logo,.mock-title,.mock-lines,.mock-footer{
  border-radius: 10px;
  background: rgba(2,6,23,.08);
  border: 1px solid var(--stroke);
}
body.dark-mode .mock-logo,
body.dark-mode .mock-title,
body.dark-mode .mock-lines,
body.dark-mode .mock-footer{ background: rgba(255,255,255,.08); }

.mock-logo{ height: 34px; width: 34px; border-radius: 12px; margin-bottom: 12px; }
.mock-title{ height: 16px; width: 70%; margin-bottom: 10px; }
.mock-lines{ height: 10px; width: 100%; margin-bottom: 8px; }
.mock-lines.short{ width: 70%; }
.mock-footer{ height: 12px; width: 45%; margin-top: 12px; }

/* Responsive */
@media (max-width: 1100px){
  .grid{ grid-template-columns: repeat(4, minmax(0, 1fr)); }
  .cert-header{ grid-template-columns: 1fr; }
  .progress{ width: 100%; max-width: none; min-width: 0; }
  .apply-area{ grid-template-columns: 1fr; }
}
...
:root{ --sidebar-open: 280px; --sidebar-closed: 90px; --sidebar-w: var(--sidebar-open); }
body.sidebar-collapsed{ --sidebar-w: var(--sidebar-closed); }

/* apply to your main content wrapper (whatever contains cert-wrap) */
.main-content{
  margin-left: var(--sidebar-w);
  transition: margin-left .25s ease;
}

/* ===== Certificate page: force full width ===== */
.cert-page{
  width: 100%;
}

/* This is the REAL fix: parent containers are limiting width */
.cert-page :is(.container, .container-fluid, .content, .content-wrapper, .page-content, .main, .main-content, .app-content){
  max-width: none !important;
  width: 100% !important;
}

/* Make the section actually fill the available space */
.cert-page .cert-wrap{
  width: 100% !important;
  max-width: none !important;
  margin: 0 !important;
...
<div class="profile-actions" style="justify-content: flex-end;">
    ...
    <div class="cert-header">
        <div>
            <h1>Certificate</h1>
            <p class="muted">Earn your Cognisense mastery certificate after completing all 13 skill scenarios.</p>
        </div>

        <div class="score-card">
            <div class="score-top">
                <span class="pill">Average Score</span>
                <span class="score">{{ $avgScore !== null ? number_format($avgScore, 2) : 'N/A' }}<small>/10</small></span>
            </div>
            <div class="score-sub muted">
                Based on your submitted scenario attempts (final_score).
            </div>
        </div>
    </div>

    @if($existingCertificate && $existingCertificate->pdf_path)
        <div class="existing">
            <div>
                <h3>Your certificate is ready</h3>
                <p class="muted">Certificate No: <b>{{ $existingCertificate->certificate_no }}</b></p>
            </div>
            <div class="existing-actions">
                <a class="btn" href="{{ route('certificate.show', $existingCertificate) }}">View</a>
                <a class="btn btn-ghost" href="{{ route('certificate.download', $existingCertificate) }}">Download</a>
            </div>
        </div>
    @endif
    ...
    <div class="eligibility">
        <div class="elig-head">
            ...
            <div class="muted">
                Completed <b>{{ count($approvedScenarioIds) }}</b> / <b>{{ count($requiredScenarioIds) }}</b>
                @if($enforceEligibility)
                    <span class="pill warn">Enforced</span>
                @else
                    <span class="pill ok">Testing Mode</span>
                @endif
            </div>
        </div>

        <div class="grid">
            @foreach($requiredScenarioIds as $sid)
                @php $done = in_array($sid, $approvedScenarioIds); @endphp
                <div class="skill {{ $done ? 'done' : 'todo' }}">
                    <div class="skill-top">
                        <div class="skill-id">Scenario {{ $sid }}</div>
                        <div class="dot"></div>
                    </div>
                    <div class="skill-status">
                        {{ $done ? 'Approved' : 'Not completed' }}
                    </div>
                </div>
            @endforeach
        </div>

        @if($enforceEligibility && !$isEligible)
            <div class="gate">
                <h3>Complete all skill tests to unlock certificate</h3>
                <p class="muted">You’re missing: {{ implode(', ', $missingScenarioIds) }}</p>
                <a class="btn" href="/dashboard">Go to Skill Tests</a>
            </div>
        @endif
    </div>

    {{-- Form (only show if canApply, which is true in testing mode) --}}
    @if($canApply)
        <div class="apply-area">
            <div class="form-3d" id="form3d">
                <div class="form-3d-inner">
                    <div class="form-title">
                        <div class="badge">Cognisense</div>
                        <h2>Apply for Certificate</h2>
                        <p class="muted">Enter your details exactly as you want them to appear on the certificate.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('certificate.store') }}" class="cert-form">
                        @csrf

                        <div class="row">
                            <div class="field">
                                <label>Full Name</label>
                                <input name="full_name" value="{{ old('full_name', auth()->user()->name ?? '') }}" required maxlength="120" placeholder="e.g., Arafat Rahman" />
                            </div>
                            <div class="field">
                                <label>Email</label>
                                <input name="email" type="email" value="{{ old('email', auth()->user()->email ?? '') }}" required maxlength="160" placeholder="e.g., you@example.com" />
                            </div>
                        </div>
                        ...
                        <div class="note">
                            ...
                            <div class="note-text">
                                By submitting, you request issuance of a certificate stating that you have completed and mastered all 13 Cognisense skills.
                            </div>
                        </div>
                        ...
                        <div class="actions">
                            ...
                            <span class="muted tiny">A PDF will be generated instantly and available to view/download.</span>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="preview-card">
                ...
                <p class="muted">Your generated certificate will contain the Cognisense logo, your name, average score, and an official completion note.</p>
                <div class="preview-mock">
                    <div class="mock-logo"></div>
                    <div class="mock-title"></div>
                    <div class="mock-lines"></div>
                    <div class="mock-lines short"></div>
...
<script>
(function(){
  const card = document.getElementById('form3d');
  if(!card) return;
  const inner = card.querySelector('.form-3d-inner');
  ...
  card.addEventListener('mousemove', (e) => {
    ...
    inner.style.transform = `rotateX(${rotX}deg) rotateY(${rotY}deg) translateZ(0px)`;
  });
